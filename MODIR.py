...
# --- HTML Template با انیمیشن و رنگ‌های نئونی ---
main_template = '''
<!DOCTYPE html>
...
<body>
    ...
    <script>
        ...
        // بررسی ورود کاربر در لود اولیه
        window.onload = function() {
            if (localStorage.getItem("isLoggedIn") === "true") {
                showSection("dashboard");
                document.getElementById("login-form").classList.add("hidden");
                document.getElementById("p-fname").textContent = localStorage.getItem("fname");
                document.getElementById("p-lname").textContent = localStorage.getItem("lname");
                document.getElementById("p-rank").textContent = localStorage.getItem("rank");
            }
        };
