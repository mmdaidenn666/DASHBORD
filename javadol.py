...
<body>
    ...
    <script>
        ...
        function editField(field, currentValue) {
            ...
            const parentElement = valueElement.parentElement.parentElement;
            ...
            if (field === 'role') {
                valueElement.innerHTML = `
                    <form class="inline-edit-form" method="POST" action="/edit_profile">
                        ...
                        <button type="submit" class="inline-edit-btn save-btn">✓</button>
                        <button type="button" class="inline-edit-btn cancel-btn" onclick="cancelEdit('${field}', '${currentValue}')">✗</button>
                    </form>
                `;
            } else {
                valueElement.innerHTML = `
