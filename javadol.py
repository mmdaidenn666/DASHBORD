...
<body>
            ...
            {% if page == 'profile' %}
                ...
                <div class="profile-container">
                    <div class="profile-item">
                        <span><strong>نام:</strong> <span id="name-value">{{ session.name }}</span></span>
                        <button class="edit-btn" onclick="editInline('name', '{{ session.name }}')">✎</button>
                    </div>
                    <div class="profile-item">
                        <span><strong>نام خانوادگی:</strong> <span id="lastname-value">{{ session.lastname }}</span></span>
                        <button class="edit-btn" onclick="editInline('lastname', '{{ session.lastname }}')">✎</button>
                    </div>
                    <div class="profile-item">
                        <span><strong>مرتبه:</strong> <span id="role-value">{{ session.role }}</span></span>
                        <button class="edit-btn" onclick="editRoleInline('{{ session.role }}')">✎</button>
                    </div>
                    <div class="profile-item">
    ...
    {% if session.get('logged_in') and page not in ['add_student', 'edit_student'] %}
        <div class="toolbar">
    ...
    <script>
        ...
        function editInline(field, currentValue) {
            const valueElement = document.getElementById(field + '-value');
            const currentValueText = valueElement.textContent;
            
            valueElement.innerHTML = `
                <input type="text" class="inline-edit-input" id="edit-${field}" value="${currentValueText}" />
                <div class="inline-edit-buttons">
                    <button class="inline-edit-btn save-btn" onclick="saveInlineEdit('${field}')">✓</button>
                    <button class="inline-edit-btn cancel-btn" onclick="cancelInlineEdit('${field}', '${currentValueText}')">✗</button>
                </div>
            `;
        }
        ...
        function editRoleInline(currentValue) {
            const valueElement = document.getElementById('role-value');
            
            valueElement.innerHTML = `
                <select class="inline-edit-select" id="edit-role">
                ...
                <div class="inline-edit-buttons">
                    <button class="inline-edit-btn save-btn" onclick="saveRoleEdit()">✓</button>
                    <button class="inline-edit-btn cancel-btn" onclick="cancelRoleEdit('${currentValue}')">✗</button>
                </div>
            `;
        }
        ...
        function cancelRoleEdit(originalValue) {
            const valueElement = document.getElementById('role-value');
            valueElement.textContent = originalValue;
        }
