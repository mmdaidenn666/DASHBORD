...
def dashboard():
    ...
    return render_template_string(DASHBOARD_TEMPLATE, unread_count=unread_count)
        ...
        <div class="auth-form">
            <form method="post" enctype="multipart/form-data">
                <div style="text-align: center;">
                    <label for="profile_pic" class="add-photo-circle">
                        +
                    </label>
...
<body>
    ...
    <main>
        <div style="text-align: center; margin: 30px 0;">
            ...
            <h2 style="color: var(--neon-blue);">{{ current_user.name or current_user.username }}</h2>
            <p style="color: var(--light-gray);">@{{ current_user.username }}</p>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 15px; max-width: 400px; margin: 0 auto;">
            ...
            <a href="{{ url_for('notifications') }}" class="neon-btn" style="text-align: center;">
                ...
                {% if unread_count > 0 %}
                <span style="background: var(--neon-pink); color: white; border-radius: 50%; padding: 2px 6px; font-size: 12px; margin-left: 5px;">
                    {{ unread_count if unread_count <= 9 else '9+' }}
                </span>
                {% endif %}
            </a>
...
<body>
    ...
    <main>
        ...
        <div style="max-width: 500px; margin: 0 auto; background: var(--card-bg); padding: 20px; border-radius: 15px;">
            <form method="post" enctype="multipart/form-data">
            ...
            <div style="margin-top: 30px; text-align: center;">
                ...
                <button onclick="if(confirm('آیا مطمئنید؟ این عمل غیرقابل بازگشت است.')) location.href='{{ url_for('delete_account') }}'" 
                        class="neon-btn" 
                        style="background: linear-gradient(90deg, #ff4757, #ff6b81); width: 100%;">
                    حذف حساب
                </button>
            </div>
        </div>
