            ...
            <form method="post" enctype="multipart/form-data">
                <div style="text-align: center;">
                    <label for="profile_pic" style="cursor: pointer;">
                        <div class="add-photo-circle" style="margin: 20px auto;">
                            +
                        </div>
                    </label>
            ...
            {% if notifications %}
                ...
                <div class="notification {% if not notif.is_read %}unread{% endif %}">
                    ...
                    <div style="margin-top: 10px; display: flex; gap: 10px;">
                        ...
                        <button onclick="blockUser({{ notif.sender_id }})" 
                                style="background: var(--neon-pink); color: white; padding: 5px 10px; border: none; border-radius: 5px; font-size: 12px;">
                            🚫 بلاک
                        </button>
                    </div>
                    {% endif %}
