...
def student_login():
    ...
    <div style="background:#0D0D0D; color:white; font-family:Vazir,sans-serif; padding:30px 20px; text-align:center; direction:rtl; min-height:100vh;">
        <h2 style="color:#00FF9C; text-shadow:0 0 10px #00FF9C; font-size:24px;">ورود دانش آموزان</h2>
        <p style="margin:20px 0; font-size:18px;">این بخش در حال توسعه است.</p>
        <a href="/" style="color:#00FF9C; text-decoration:underline; display:inline-block; margin-top:20px; font-size:18px;">بازگشت به صفحه اصلی</a>
    </div>
    '''
